...
| 工作包 | 状态 | 当前证据 | 未闭合边界 |
|---|---|---|---|
| C00 | `SPEC_ONLY / IN_PROGRESS` | `docs/spec/product/`；`scripts/rkgenerateproduct.py`；`sdk/`；`tests/test_product_contract.py` | 完整 payload/result schema、GraphSlice、材料/文献/题池/谱系对象、可调用客户端、无损往返 |
...
| 其余 C/D/P/B/F/I/R | `NOT_STARTED` | 无新产品完成证据 | 依本文拓扑推进 |
