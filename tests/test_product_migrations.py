...
def test_project_baseline_has_stable_identity_and_owned_objects() -> None:
    ...
    assert [(step.position, step.fragment.fragment_id) for step in plan] == [
        ...
        (14, "B07b/contracts"),
        (15, "B08a/literature"),
        (16, "B08b/literature_graph"),
        (17, "B09a/work_activity"),
        (18, "B09b/route_plan"),
        (19, "B09c/ablation"),
        (20, "B10/claims"),
        (21, "B10b/research_draft"),
        (22, "B11a/invalidation"),
        (23, "B11b/revocation"),
        (24, "B12a/tool_runs"),
        (25, "B12b/environments"),
        (26, "B13/scheduling"),
        (27, "B14/guidance"),
        (28, "B15a/publication"),
        (29, "B15b/publication_artifacts"),
        (30, "B16a/deployment"),
        (31, "B16c/backup"),
        (32, "B17/problem_pool"),
        (33, "B18/research_lineage"),
    ]
