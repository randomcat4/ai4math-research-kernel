...
def test_project_baseline_has_stable_identity_and_owned_objects() -> None:
    ...
    assert [(step.position, step.fragment.fragment_id) for step in plan] == [
        ...
        (9, "B05a/identity"),
        (10, "B05b/reviews"),
        (11, "B05c/identity_roles"),
        (12, "B05d/managed_sessions"),
        (13, "B06a/graph_index"),
        (14, "B07a/materials"),
        (15, "B07b/contracts"),
        (16, "B08a/literature"),
        (17, "B08b/literature_graph"),
        (18, "B09a/work_activity"),
        (19, "B09b/route_plan"),
        (20, "B09c/ablation"),
        (21, "B10/claims"),
        (22, "B10b/research_draft"),
        (23, "B11a/invalidation"),
        (24, "B11b/revocation"),
        (25, "B12a/tool_runs"),
        (26, "B12b/environments"),
        (27, "B13/scheduling"),
        (28, "B14/guidance"),
        (29, "B15a/publication"),
        (30, "B15b/publication_artifacts"),
        (31, "B16a/deployment"),
        (32, "B16c/backup"),
        (33, "B17/problem_pool"),
        (34, "B17b/pool_artifacts"),
        (35, "B18/research_lineage"),
    ]
