...
def test_project_baseline_has_stable_identity_and_owned_objects() -> None:
    ...
    assert [(step.position, step.fragment.fragment_id) for step in plan] == [
        ...
        (13, "B07b/contracts"),
        (14, "B08a/literature"),
        (15, "B08b/literature_graph"),
        (16, "B09a/work_activity"),
        (17, "B09b/route_plan"),
        (18, "B09c/ablation"),
        (19, "B10/claims"),
        (20, "B10b/research_draft"),
        (21, "B11a/invalidation"),
        (22, "B11b/revocation"),
        (23, "B12a/tool_runs"),
        (24, "B12b/environments"),
        (25, "B13/scheduling"),
        (26, "B14/guidance"),
        (27, "B15a/publication"),
        (28, "B15b/publication_artifacts"),
        (29, "B16a/deployment"),
        (30, "B16c/backup"),
        (31, "B17/problem_pool"),
        (32, "B18/research_lineage"),
    ]
